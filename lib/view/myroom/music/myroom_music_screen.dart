                        ...
                        children: [
                              ...
                              children: [
                                Obx(() => Row(
                                      children: [
                                        Checkbox(
                                          value:
                                              musicViewModel.isVocalMusic.value,
                                          onChanged: (value) {
                            ...
                            child: Row(
                              ...
                              children: [
                                Obx(() => Row(
                                      children: [
                                        Checkbox(
                                          value: musicViewModel
                                              .isInstrumentalMusic.value,
                                          onChanged: (value) {
                                            musicViewModel
                                                .toggleInstrumentalMusic();
                                          },
                                        ),
                                        const SizedBox(width: 5),
                                        Text('연주',
                          ...
                          Container(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Obx(() {
                                return Column(
                                  children: musicViewModel.DUMMY_DATA[
                                          musicViewModel
